...
# # <center>Machine Learning in Python (Linear Regression and Classifier Algorithms)</center>
# ## <center> Keith Letourneau </center>
# <center> Northeastern Univ. </center>
...
# <ul><li>Create random samples of the training data set (sub sets of training data set)</li> 
#     <li>Build a model for each sample</li> 
#     <li>Results of these multiple models are combined using average or majority voting</li>
# </ul>
